...
sudo dpkg -i ./lliurex21/nwfermi-daemon_0.6.5.1-0+lliurex7_amd64.deb
#sudo dpkg -i ./lliurex21/nwfermi-module_0.6.5.1-0+lliurex7_amd64.deb
#sudo dpkg -i ./lliurex21/nwfermi-module-host_0.6.5.1-0+lliurex7_amd64.deb.deb
sudo dpkg -i ./lliurex21/nwfermi-module-host-pointer_0.6.5.1-0+lliurex7_amd64.deb.deb
